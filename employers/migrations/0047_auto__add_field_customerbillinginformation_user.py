...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerBillingInformation.user'
        db.add_column(u'employers_customerbillinginformation', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerBillingInformation.user'
        db.delete_column(u'employers_customerbillinginformation', 'user_id')
