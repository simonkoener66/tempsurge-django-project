...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'employers_job', (
            ...
            ('budget', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
    ...
    models = {
        ...
        u'employers.job': {
            ...
            'budget': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
