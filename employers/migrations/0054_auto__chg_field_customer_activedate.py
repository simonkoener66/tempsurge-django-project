...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.activedate'
        db.alter_column(u'employers_customer', 'activedate', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Customer.activedate'
        db.alter_column(u'employers_customer', 'activedate', self.gf('django.db.models.fields.DateTimeField')(default=0))
