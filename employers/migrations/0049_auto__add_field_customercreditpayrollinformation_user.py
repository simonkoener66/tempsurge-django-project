...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerCreditPayrollInformation.user'
        db.add_column(u'employers_customercreditpayrollinformation', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerCreditPayrollInformation.user'
        db.delete_column(u'employers_customercreditpayrollinformation', 'user_id')
