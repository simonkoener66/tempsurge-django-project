...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field interest_codes on 'Customer'
        m2m_table_name = db.shorten_name(u'employers_customer_interest_codes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customer', models.ForeignKey(orm[u'employers.customer'], null=False)),
            ('interestcode', models.ForeignKey(orm[u'temps.interestcode'], null=False))
        ))
        db.create_unique(m2m_table_name, ['customer_id', 'interestcode_id'])


    def backwards(self, orm):
        # Removing M2M table for field interest_codes on 'Customer'
        db.delete_table(db.shorten_name(u'employers_customer_interest_codes'))
