...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDepartment.active'
        db.add_column(u'employers_customerdepartment', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CustomerDepartment.activedate'
        db.add_column(u'employers_customerdepartment', 'activedate',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerDepartment.active'
        db.delete_column(u'employers_customerdepartment', 'active')

        # Deleting field 'CustomerDepartment.activedate'
        db.delete_column(u'employers_customerdepartment', 'activedate')
