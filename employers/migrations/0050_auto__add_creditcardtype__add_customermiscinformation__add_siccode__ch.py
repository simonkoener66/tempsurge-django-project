...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CreditCardType'
        db.create_table(u'employers_creditcardtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['CreditCardType'])

        # Adding model 'CustomerMiscInformation'
        db.create_table(u'employers_customermiscinformation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('edi_rpt', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('sic_code', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sic_code', null=True, to=orm['employers.SICCode'])),
            ('alternate_customerid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('desired_gm', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('alternate_branch_name', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('default_permanent_order', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('federal_employerid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('third_shift_starts_sunday', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('auto_factor_invoices', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('credit_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('card_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='credit_cardtype', null=True, to=orm['employers.CreditCardType'])),
            ('card_expiration', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('name_on_card', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'employers', ['CustomerMiscInformation'])

        # Adding model 'SICCode'
        db.create_table(u'employers_siccode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'employers', ['SICCode'])


        # Changing field 'CustomerCreditPayrollInformation.payroll_note'
        db.alter_column(u'employers_customercreditpayrollinformation', 'payroll_note', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):
        # Deleting model 'CreditCardType'
        db.delete_table(u'employers_creditcardtype')

        # Deleting model 'CustomerMiscInformation'
        db.delete_table(u'employers_customermiscinformation')

        # Deleting model 'SICCode'
        db.delete_table(u'employers_siccode')


        # Changing field 'CustomerCreditPayrollInformation.payroll_note'
        db.alter_column(u'employers_customercreditpayrollinformation', 'payroll_note', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
    ...
    models = {
        ...
        u'employers.creditcardtype': {
            'Meta': {'object_name': 'CreditCardType'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        ...
        u'employers.customercreditpayrollinformation': {
            ...
            'payroll_note': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
        ...
        u'employers.customermiscinformation': {
            'Meta': {'object_name': 'CustomerMiscInformation'},
            'alternate_branch_name': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'alternate_customerid': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'auto_factor_invoices': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'card_expiration': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'card_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'credit_cardtype'", 'null': 'True', 'to': u"orm['employers.CreditCardType']"}),
            'credit_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'default_permanent_order': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'desired_gm': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'edi_rpt': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'federal_employerid': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name_on_card': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'sic_code': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'sic_code'", 'null': 'True', 'to': u"orm['employers.SICCode']"}),
            'third_shift_starts_sunday': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
