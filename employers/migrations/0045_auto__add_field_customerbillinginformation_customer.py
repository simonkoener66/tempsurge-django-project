...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerBillingInformation.customer'
        db.add_column(u'employers_customerbillinginformation', 'customer',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['employers.Customer'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerBillingInformation.customer'
        db.delete_column(u'employers_customerbillinginformation', 'customer_id')
    ...
    models = {
        ...
        u'employers.customerbillinginformation': {
            ...
            'customer': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['employers.Customer']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
