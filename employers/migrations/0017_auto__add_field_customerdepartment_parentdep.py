...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerDepartment.parentdep'
        db.add_column(u'employers_customerdepartment', 'parentdep',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parentdepartment', null=True, to=orm['employers.CustomerDepartment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerDepartment.parentdep'
        db.delete_column(u'employers_customerdepartment', 'parentdep_id')
