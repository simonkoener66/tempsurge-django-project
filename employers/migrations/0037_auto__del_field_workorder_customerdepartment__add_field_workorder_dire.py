...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkOrder.customerdepartment'
        db.delete_column(u'employers_workorder', 'customerdepartment_id')

        # Adding field 'WorkOrder.directions'
        db.add_column(u'employers_workorder', 'directions',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.capacity_required'
        db.add_column(u'employers_workorder', 'capacity_required',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.capacity_assigned'
        db.add_column(u'employers_workorder', 'capacity_assigned',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.order_type'
        db.add_column(u'employers_workorder', 'order_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ordertype', null=True, to=orm['employers.WorkOrderType']),
                      keep_default=False)

        # Adding field 'WorkOrder.job_title'
        db.add_column(u'employers_workorder', 'job_title',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ordertype', null=True, to=orm['employers.JobTitle']),
                      keep_default=False)

        # Adding field 'WorkOrder.description'
        db.add_column(u'employers_workorder', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.dress_code'
        db.add_column(u'employers_workorder', 'dress_code',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.safety_notes'
        db.add_column(u'employers_workorder', 'safety_notes',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.start_date'
        db.add_column(u'employers_workorder', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.duration'
        db.add_column(u'employers_workorder', 'duration',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.end_date'
        db.add_column(u'employers_workorder', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.shift'
        db.add_column(u'employers_workorder', 'shift',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.start_time'
        db.add_column(u'employers_workorder', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.end_time'
        db.add_column(u'employers_workorder', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.shift_notes'
        db.add_column(u'employers_workorder', 'shift_notes',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.workday_sunday'
        db.add_column(u'employers_workorder', 'workday_sunday',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkOrder.workday_monday'
        db.add_column(u'employers_workorder', 'workday_monday',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WorkOrder.workday_tuesday'
        db.add_column(u'employers_workorder', 'workday_tuesday',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WorkOrder.workday_wednesday'
        db.add_column(u'employers_workorder', 'workday_wednesday',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WorkOrder.workday_thursday'
        db.add_column(u'employers_workorder', 'workday_thursday',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WorkOrder.workday_friday'
        db.add_column(u'employers_workorder', 'workday_friday',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WorkOrder.workday_saturday'
        db.add_column(u'employers_workorder', 'workday_saturday',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkOrder.pay_rate'
        db.add_column(u'employers_workorder', 'pay_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.bill_rate'
        db.add_column(u'employers_workorder', 'bill_rate',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.overtime_bill'
        db.add_column(u'employers_workorder', 'overtime_bill',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.doubletime_bill'
        db.add_column(u'employers_workorder', 'doubletime_bill',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.overtime_plan'
        db.add_column(u'employers_workorder', 'overtime_plan',
                      self.gf('django.db.models.fields.CharField')(default='PlanSTD', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.ot_factor'
        db.add_column(u'employers_workorder', 'ot_factor',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.multiplier'
        db.add_column(u'employers_workorder', 'multiplier',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.pay_periods'
        db.add_column(u'employers_workorder', 'pay_periods',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.gp_percent'
        db.add_column(u'employers_workorder', 'gp_percent',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.gp_estimate'
        db.add_column(u'employers_workorder', 'gp_estimate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.desired_gm'
        db.add_column(u'employers_workorder', 'desired_gm',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.active'
        db.add_column(u'employers_workorder', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'WorkOrder.status'
        db.add_column(u'employers_workorder', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Unfilled', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.rep'
        db.add_column(u'employers_workorder', 'rep',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='representative', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'WorkOrder.branch'
        db.add_column(u'employers_workorder', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sales_branch', null=True, to=orm['agencies.Branch']),
                      keep_default=False)

        # Adding field 'WorkOrder.do_not_auto_close'
        db.add_column(u'employers_workorder', 'do_not_auto_close',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkOrder.notes'
        db.add_column(u'employers_workorder', 'notes',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WorkOrder.officephone'
        db.add_column(u'employers_workorder', 'officephone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'WorkOrder.customerdepartment'
        db.add_column(u'employers_workorder', 'customerdepartment',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='customerdepartment', null=True, to=orm['employers.CustomerDepartment'], blank=True),
                      keep_default=False)

        # Deleting field 'WorkOrder.directions'
        db.delete_column(u'employers_workorder', 'directions')

        # Deleting field 'WorkOrder.capacity_required'
        db.delete_column(u'employers_workorder', 'capacity_required')

        # Deleting field 'WorkOrder.capacity_assigned'
        db.delete_column(u'employers_workorder', 'capacity_assigned')

        # Deleting field 'WorkOrder.order_type'
        db.delete_column(u'employers_workorder', 'order_type_id')

        # Deleting field 'WorkOrder.job_title'
        db.delete_column(u'employers_workorder', 'job_title_id')

        # Deleting field 'WorkOrder.description'
        db.delete_column(u'employers_workorder', 'description')

        # Deleting field 'WorkOrder.dress_code'
        db.delete_column(u'employers_workorder', 'dress_code')

        # Deleting field 'WorkOrder.safety_notes'
        db.delete_column(u'employers_workorder', 'safety_notes')

        # Deleting field 'WorkOrder.start_date'
        db.delete_column(u'employers_workorder', 'start_date')

        # Deleting field 'WorkOrder.duration'
        db.delete_column(u'employers_workorder', 'duration')

        # Deleting field 'WorkOrder.end_date'
        db.delete_column(u'employers_workorder', 'end_date')

        # Deleting field 'WorkOrder.shift'
        db.delete_column(u'employers_workorder', 'shift')

        # Deleting field 'WorkOrder.start_time'
        db.delete_column(u'employers_workorder', 'start_time')

        # Deleting field 'WorkOrder.end_time'
        db.delete_column(u'employers_workorder', 'end_time')

        # Deleting field 'WorkOrder.shift_notes'
        db.delete_column(u'employers_workorder', 'shift_notes')

        # Deleting field 'WorkOrder.workday_sunday'
        db.delete_column(u'employers_workorder', 'workday_sunday')

        # Deleting field 'WorkOrder.workday_monday'
        db.delete_column(u'employers_workorder', 'workday_monday')

        # Deleting field 'WorkOrder.workday_tuesday'
        db.delete_column(u'employers_workorder', 'workday_tuesday')

        # Deleting field 'WorkOrder.workday_wednesday'
        db.delete_column(u'employers_workorder', 'workday_wednesday')

        # Deleting field 'WorkOrder.workday_thursday'
        db.delete_column(u'employers_workorder', 'workday_thursday')

        # Deleting field 'WorkOrder.workday_friday'
        db.delete_column(u'employers_workorder', 'workday_friday')

        # Deleting field 'WorkOrder.workday_saturday'
        db.delete_column(u'employers_workorder', 'workday_saturday')

        # Deleting field 'WorkOrder.pay_rate'
        db.delete_column(u'employers_workorder', 'pay_rate')

        # Deleting field 'WorkOrder.bill_rate'
        db.delete_column(u'employers_workorder', 'bill_rate')

        # Deleting field 'WorkOrder.overtime_bill'
        db.delete_column(u'employers_workorder', 'overtime_bill')

        # Deleting field 'WorkOrder.doubletime_bill'
        db.delete_column(u'employers_workorder', 'doubletime_bill')

        # Deleting field 'WorkOrder.overtime_plan'
        db.delete_column(u'employers_workorder', 'overtime_plan')

        # Deleting field 'WorkOrder.ot_factor'
        db.delete_column(u'employers_workorder', 'ot_factor')

        # Deleting field 'WorkOrder.multiplier'
        db.delete_column(u'employers_workorder', 'multiplier')

        # Deleting field 'WorkOrder.pay_periods'
        db.delete_column(u'employers_workorder', 'pay_periods')

        # Deleting field 'WorkOrder.gp_percent'
        db.delete_column(u'employers_workorder', 'gp_percent')

        # Deleting field 'WorkOrder.gp_estimate'
        db.delete_column(u'employers_workorder', 'gp_estimate')

        # Deleting field 'WorkOrder.desired_gm'
        db.delete_column(u'employers_workorder', 'desired_gm')

        # Deleting field 'WorkOrder.active'
        db.delete_column(u'employers_workorder', 'active')

        # Deleting field 'WorkOrder.status'
        db.delete_column(u'employers_workorder', 'status')

        # Deleting field 'WorkOrder.rep'
        db.delete_column(u'employers_workorder', 'rep_id')

        # Deleting field 'WorkOrder.branch'
        db.delete_column(u'employers_workorder', 'branch_id')

        # Deleting field 'WorkOrder.do_not_auto_close'
        db.delete_column(u'employers_workorder', 'do_not_auto_close')

        # Deleting field 'WorkOrder.notes'
        db.delete_column(u'employers_workorder', 'notes')

        # Deleting field 'WorkOrder.officephone'
        db.delete_column(u'employers_workorder', 'officephone')
    ...
    models = {
        ...
        u'employers.workorder': {
            ...
            'doubletime_bill': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_title': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ordertype'", 'null': 'True', 'to': u"orm['employers.JobTitle']"}),
            ...
            'overtime_bill': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
