...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'employers_job', (
            ...
            ('budget', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ...
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='temp', null=True, to=orm['temps.Temp'], blank=True)),
