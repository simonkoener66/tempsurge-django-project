...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.billing_address_line_1'
        db.add_column(u'employers_customer', 'billing_address_line_1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Customer.billing_address_line_2'
        db.add_column(u'employers_customer', 'billing_address_line_2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Customer.billing_city'
        db.add_column(u'employers_customer', 'billing_city',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.City'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.billing_state'
        db.add_column(u'employers_customer', 'billing_state',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.State'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.billing_zip'
        db.add_column(u'employers_customer', 'billing_zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Customer.billing_country'
        db.add_column(u'employers_customer', 'billing_country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.Country'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Customer.billing_address_line_1'
        db.delete_column(u'employers_customer', 'billing_address_line_1')

        # Deleting field 'Customer.billing_address_line_2'
        db.delete_column(u'employers_customer', 'billing_address_line_2')

        # Deleting field 'Customer.billing_city'
        db.delete_column(u'employers_customer', 'billing_city_id')

        # Deleting field 'Customer.billing_state'
        db.delete_column(u'employers_customer', 'billing_state_id')

        # Deleting field 'Customer.billing_zip'
        db.delete_column(u'employers_customer', 'billing_zip')

        # Deleting field 'Customer.billing_country'
        db.delete_column(u'employers_customer', 'billing_country_id')
