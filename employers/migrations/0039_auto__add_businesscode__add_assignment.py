...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusinessCode'
        db.create_table(u'employers_businesscode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['BusinessCode'])

        # Adding model 'Assignment'
        db.create_table(u'employers_assignment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_workorder', null=True, to=orm['employers.WorkOrder'])),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_employee', null=True, to=orm['temps.Temp'])),
            ('temp_phone', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='Open', max_length=20, null=True, blank=True)),
            ('replaces', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_replaces', null=True, to=orm['employers.Assignment'])),
            ('customer_nda', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('employee_nda', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('job_title', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_jobtitle', null=True, to=orm['employers.JobTitle'])),
            ('business_code', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_businesscode', null=True, to=orm['employers.BusinessCode'])),
            ('expected_start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('expected_end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('original_start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('original_end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('shift', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('shift_notes', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('workday_sunday', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('workday_monday', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('workday_tuesday', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('workday_wednesday', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('workday_thursday', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('workday_friday', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('workday_saturday', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('multiplier', self.gf('django.db.models.fields.CharField')(default='None', max_length=20, null=True, blank=True)),
            ('ot_factor', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('pay_rate', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('bill_rate', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('salary', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('salary_bill', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('units_bill', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('units_pay_rate', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('other_agency_pay', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('overtime_bill', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('overtime_pay', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('doubletime_bill', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('doubletime_pay', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('payroll_notes', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('rep', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_representative', null=True, to=orm['auth.User'])),
            ('entered_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_enteredby', null=True, to=orm['auth.User'])),
            ('referred_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_referredby', null=True, to=orm['auth.User'])),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assignment_sales_branch', null=True, to=orm['agencies.Branch'])),
            ('do_not_auto_close', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('assigned_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('perf_notes', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
        ))
        db.send_create_signal(u'employers', ['Assignment'])


    def backwards(self, orm):
        # Deleting model 'BusinessCode'
        db.delete_table(u'employers_businesscode')

        # Deleting model 'Assignment'
        db.delete_table(u'employers_assignment')
