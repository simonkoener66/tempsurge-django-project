...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PayrollCheckDelivery'
        db.create_table(u'employers_payrollcheckdelivery', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'employers', ['PayrollCheckDelivery'])

        # Adding model 'PayrollOvertimePlan'
        db.create_table(u'employers_payrollovertimeplan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('plan', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('plantype', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'employers', ['PayrollOvertimePlan'])

        # Adding model 'CustomerCreditPayrollInformation'
        db.create_table(u'employers_customercreditpayrollinformation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('credit_limit', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('credit_analyst', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='credit_analyst', null=True, to=orm['auth.User'])),
            ('hold_code', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='holdcode', null=True, to=orm['employers.CreditHoldCode'])),
            ('terms', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='creditterms', null=True, to=orm['employers.CreditTerms'])),
            ('last_checked', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('customer_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='creditcustomertype', null=True, to=orm['employers.CustomerType'])),
            ('credit_note', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('worker_comp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='worker_comp', null=True, to=orm['employers.WorkerComp'])),
            ('check_delivery', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='check_delivery', null=True, to=orm['employers.PayrollCheckDelivery'])),
            ('overtime_plan', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='overtime_plan', null=True, to=orm['employers.PayrollOvertimePlan'])),
            ('pay_periods', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('weekendson', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('pay_cycle', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('mileage_rate', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('payroll_note', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('ar_balance', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('ar_current', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('ar_1_30_days', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('ar_31_60_days', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('ar_61_90_days', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('ar_over90_days', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('dso', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('sales_tyd', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('sales_last12mo', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('lifetime_sales', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('volume_discount', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'employers', ['CustomerCreditPayrollInformation'])

        # Adding model 'WorkerComp'
        db.create_table(u'employers_workercomp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('percentage', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=12, decimal_places=2, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('state', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['geo.State'], null=True, blank=True)),
        ))
        db.send_create_signal(u'employers', ['WorkerComp'])

        # Adding model 'CreditHoldCode'
        db.create_table(u'employers_creditholdcode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['CreditHoldCode'])

        # Adding model 'CustomerType'
        db.create_table(u'employers_customertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customertype', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['CustomerType'])

        # Adding model 'CreditTerms'
        db.create_table(u'employers_creditterms', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('terms', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['CreditTerms'])


    def backwards(self, orm):
        # Deleting model 'PayrollCheckDelivery'
        db.delete_table(u'employers_payrollcheckdelivery')

        # Deleting model 'PayrollOvertimePlan'
        db.delete_table(u'employers_payrollovertimeplan')

        # Deleting model 'CustomerCreditPayrollInformation'
        db.delete_table(u'employers_customercreditpayrollinformation')

        # Deleting model 'WorkerComp'
        db.delete_table(u'employers_workercomp')

        # Deleting model 'CreditHoldCode'
        db.delete_table(u'employers_creditholdcode')

        # Deleting model 'CustomerType'
        db.delete_table(u'employers_customertype')

        # Deleting model 'CreditTerms'
        db.delete_table(u'employers_creditterms')
    ...
    models = {
        ...
        u'employers.creditholdcode': {
            'Meta': {'object_name': 'CreditHoldCode'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'employers.creditterms': {
            'Meta': {'object_name': 'CreditTerms'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'terms': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        ...
        u'employers.customercreditpayrollinformation': {
            'Meta': {'object_name': 'CustomerCreditPayrollInformation'},
            'ar_1_30_days': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'ar_31_60_days': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'ar_61_90_days': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'ar_balance': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'ar_current': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'ar_over90_days': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'check_delivery': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'check_delivery'", 'null': 'True', 'to': u"orm['employers.PayrollCheckDelivery']"}),
            'credit_analyst': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'credit_analyst'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'credit_limit': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'credit_note': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'customer_type': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'creditcustomertype'", 'null': 'True', 'to': u"orm['employers.CustomerType']"}),
            'dso': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'hold_code': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'holdcode'", 'null': 'True', 'to': u"orm['employers.CreditHoldCode']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'lifetime_sales': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'mileage_rate': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'overtime_plan': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'overtime_plan'", 'null': 'True', 'to': u"orm['employers.PayrollOvertimePlan']"}),
            'pay_cycle': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'pay_periods': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'payroll_note': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'sales_last12mo': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'sales_tyd': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'terms': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'creditterms'", 'null': 'True', 'to': u"orm['employers.CreditTerms']"}),
            'volume_discount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'weekendson': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            'worker_comp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'worker_comp'", 'null': 'True', 'to': u"orm['employers.WorkerComp']"})
        },
        ...
        u'employers.customertype': {
            'Meta': {'object_name': 'CustomerType'},
            'customertype': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'employers.payrollcheckdelivery': {
            'Meta': {'object_name': 'PayrollCheckDelivery'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'employers.payrollovertimeplan': {
            'Meta': {'object_name': 'PayrollOvertimePlan'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'plantype': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'employers.workercomp': {
            'Meta': {'object_name': 'WorkerComp'},
            'code': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'percentage': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'state': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['geo.State']", 'null': 'True', 'blank': 'True'})
        },
