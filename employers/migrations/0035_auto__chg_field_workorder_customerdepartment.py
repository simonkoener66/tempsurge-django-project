...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkOrder.customerdepartment'
        db.alter_column(u'employers_workorder', 'customerdepartment_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['employers.CustomerDepartment']))

    def backwards(self, orm):

        # Changing field 'WorkOrder.customerdepartment'
        db.alter_column(u'employers_workorder', 'customerdepartment_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['employers.CustomerDepartment']))
