...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SICCode.description'
        db.alter_column(u'employers_siccode', 'description', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'SICCode.description'
        db.alter_column(u'employers_siccode', 'description', self.gf('django.db.models.fields.CharField')(default=0, max_length=300))
