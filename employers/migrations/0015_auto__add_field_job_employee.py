...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.employee'
        db.add_column(u'employers_job', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='temp', null=True, to=orm['temps.Temp']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.employee'
        db.delete_column(u'employers_job', 'employee_id')
