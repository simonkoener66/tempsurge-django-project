...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomerStatus'
        db.create_table(u'employers_customerstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['CustomerStatus'])

        # Adding field 'Customer.createddate'
        db.add_column(u'employers_customer', 'createddate',
        ...
        db.add_column(u'employers_customer', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='customerstatus', null=True, to=orm['employers.CustomerStatus']),
                      keep_default=False)


        # Changing field 'Customer.activedate'
        db.alter_column(u'employers_customer', 'activedate', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting model 'CustomerStatus'
        db.delete_table(u'employers_customerstatus')

        # Deleting field 'Customer.createddate'
        db.delete_column(u'employers_customer', 'createddate')

        # Deleting field 'Customer.status'
        db.delete_column(u'employers_customer', 'status_id')


        # Changing field 'Customer.activedate'
        db.alter_column(u'employers_customer', 'activedate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
