...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'employers_workorder', 'order_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ordertype', null=True, to=orm['employers.WorkOrderType'], blank=True),
                      keep_default=False)
        ...
        db.add_column(u'employers_workorder', 'rep',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='representative', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
        ...
        db.add_column(u'employers_workorder', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='sales_branch', null=True, to=orm['agencies.Branch'], blank=True),
                      keep_default=False)
        ...
        db.add_column(u'employers_workorder', 'job_title',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ordertype', null=True, to=orm['employers.JobTitle'], blank=True),
                      keep_default=False)
