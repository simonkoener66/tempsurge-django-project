...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomerDepartment'
        db.create_table(u'employers_customerdepartment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='customer', to=orm['employers.Customer'])),
            ('depname', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['CustomerDepartment'])

        # Adding model 'Customer'
        db.create_table(u'employers_customer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customername', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('attnto', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('accountmanager', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accountmanager', null=True, to=orm['auth.User'])),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='branch', null=True, to=orm['agencies.Branch'])),
            ('note', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'employers', ['Customer'])


    def backwards(self, orm):
        # Deleting model 'CustomerDepartment'
        db.delete_table(u'employers_customerdepartment')

        # Deleting model 'Customer'
        db.delete_table(u'employers_customer')
