...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'employers_workorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customerdepartment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='customerdepartment', to=orm['employers.CustomerDepartment'])),
            ('directions', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('capacity_required', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('capacity_assigned', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('order_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ordertype', null=True, to=orm['employers.WorkOrderType'])),
            ('job_title', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ordertype', null=True, to=orm['employers.JobTitle'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('dress_code', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('safety_notes', self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('duration', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ...
            ('pay_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('bill_rate', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('overtime_bill', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('doubletime_bill', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('overtime_plan', self.gf('django.db.models.fields.CharField')(default='PlanSTD', max_length=20, null=True, blank=True)),
            ('pay_periods', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gp_percent', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('gp_estimate', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('desired_gm', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('multiplier', self.gf('django.db.models.fields.CharField')(default='Unfilled', max_length=20, null=True, blank=True)),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sales_branch', null=True, to=orm['agencies.Branch'])),
            ...
            ('officephone', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
        ))
        db.send_create_signal(u'employers', ['WorkOrder'])

        # Adding model 'JobTitle'
        db.create_table(u'employers_jobtitle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['JobTitle'])

        # Adding model 'WorkOrderType'
        db.create_table(u'employers_workordertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'employers', ['WorkOrderType'])


    def backwards(self, orm):
        # Deleting model 'WorkOrder'
        db.delete_table(u'employers_workorder')

        # Deleting model 'JobTitle'
        db.delete_table(u'employers_jobtitle')

        # Deleting model 'WorkOrderType'
        db.delete_table(u'employers_workordertype')
    ...
    models = {
        ...
        u'employers.workorder': {
            ...
            'bill_rate': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            ...
            'capacity_assigned': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'capacity_required': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'desired_gm': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            ...
            'doubletime_bill': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            ...
            'gp_estimate': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            'gp_percent': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'multiplier': ('django.db.models.fields.CharField', [], {'default': "'Unfilled'", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'overtime_bill': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            ...
            'pay_rate': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
