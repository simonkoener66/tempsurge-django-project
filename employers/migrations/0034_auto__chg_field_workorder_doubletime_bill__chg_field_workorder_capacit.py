...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkOrder.doubletime_bill'
        db.alter_column(u'employers_workorder', 'doubletime_bill', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.capacity_required'
        db.alter_column(u'employers_workorder', 'capacity_required', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'WorkOrder.pay_rate'
        db.alter_column(u'employers_workorder', 'pay_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.overtime_bill'
        db.alter_column(u'employers_workorder', 'overtime_bill', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.capacity_assigned'
        db.alter_column(u'employers_workorder', 'capacity_assigned', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'WorkOrder.ot_factor'
        db.alter_column(u'employers_workorder', 'ot_factor', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.bill_rate'
        db.alter_column(u'employers_workorder', 'bill_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'WorkOrder.doubletime_bill'
        db.alter_column(u'employers_workorder', 'doubletime_bill', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.capacity_required'
        db.alter_column(u'employers_workorder', 'capacity_required', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'WorkOrder.pay_rate'
        db.alter_column(u'employers_workorder', 'pay_rate', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.overtime_bill'
        db.alter_column(u'employers_workorder', 'overtime_bill', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.capacity_assigned'
        db.alter_column(u'employers_workorder', 'capacity_assigned', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'WorkOrder.ot_factor'
        db.alter_column(u'employers_workorder', 'ot_factor', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))

        # Changing field 'WorkOrder.bill_rate'
        db.alter_column(u'employers_workorder', 'bill_rate', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2))
    ...
    models = {
        ...
        u'employers.workorder': {
            ...
            'capacity_required': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'customerdepartment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'customerdepartment'", 'to': u"orm['employers.CustomerDepartment']"}),
