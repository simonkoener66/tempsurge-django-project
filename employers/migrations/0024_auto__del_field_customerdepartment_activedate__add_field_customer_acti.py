...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.activedate'
        db.add_column(u'employers_customer', 'activedate',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Customer.activedate'
        db.delete_column(u'employers_customer', 'activedate')
