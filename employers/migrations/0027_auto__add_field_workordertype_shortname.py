...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkOrderType.shortname'
        db.add_column(u'employers_workordertype', 'shortname',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkOrderType.shortname'
        db.delete_column(u'employers_workordertype', 'shortname')
