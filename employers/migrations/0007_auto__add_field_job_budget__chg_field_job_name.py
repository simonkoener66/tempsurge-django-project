...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.budget'
        db.add_column(u'employers_job', 'budget',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)


        # Changing field 'Job.name'
        db.alter_column(u'employers_job', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Job.budget'
        db.delete_column(u'employers_job', 'budget')


        # Changing field 'Job.name'
        db.alter_column(u'employers_job', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'employers.job': {
            ...
            'budget': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
