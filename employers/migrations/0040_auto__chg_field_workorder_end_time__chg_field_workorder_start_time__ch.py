...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkOrder.end_time'
        db.alter_column(u'employers_workorder', 'end_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'WorkOrder.start_time'
        db.alter_column(u'employers_workorder', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Assignment.start_time'
        db.alter_column(u'employers_assignment', 'start_time', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'Assignment.end_time'
        db.alter_column(u'employers_assignment', 'end_time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'WorkOrder.end_time'
        db.alter_column(u'employers_workorder', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'WorkOrder.start_time'
        db.alter_column(u'employers_workorder', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Assignment.start_time'
        db.alter_column(u'employers_assignment', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Assignment.end_time'
        db.alter_column(u'employers_assignment', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
