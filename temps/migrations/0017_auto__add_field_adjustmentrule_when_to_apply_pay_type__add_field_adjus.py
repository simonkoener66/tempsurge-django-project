...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdjustmentRule.when_to_apply_pay_type'
        db.add_column(u'temps_adjustmentrule', 'when_to_apply_pay_type',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=1),
                      keep_default=False)

        # Adding field 'AdjustmentRule.when_to_apply_operator'
        db.add_column(u'temps_adjustmentrule', 'when_to_apply_operator',
                      self.gf('django.db.models.fields.CharField')(default='<=', max_length=2),
                      keep_default=False)

        # Adding field 'AdjustmentRule.when_to_apply_amount'
        db.add_column(u'temps_adjustmentrule', 'when_to_apply_amount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdjustmentRule.when_to_apply_pay_type'
        db.delete_column(u'temps_adjustmentrule', 'when_to_apply_pay_type')

        # Deleting field 'AdjustmentRule.when_to_apply_operator'
        db.delete_column(u'temps_adjustmentrule', 'when_to_apply_operator')

        # Deleting field 'AdjustmentRule.when_to_apply_amount'
        db.delete_column(u'temps_adjustmentrule', 'when_to_apply_amount')
    ...
    models = {
        ...
        u'temps.adjustmentrule': {
            ...
            'deduction_amount_type': ('django.db.models.fields.CharField', [], {'default': "'d'", 'max_length': '1', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'when_to_apply_operator': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'when_to_apply_pay_type': ('django.db.models.fields.CharField', [], {'default': "'a'", 'max_length': '1'})
        },
