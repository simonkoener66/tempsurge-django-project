...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjustment.deduct_greater_or_lesser'
        db.add_column(u'temps_adjustment', 'deduct_greater_or_lesser',
                      self.gf('django.db.models.fields.CharField')(default='l', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjustment.deduct_greater_or_lesser'
        db.delete_column(u'temps_adjustment', 'deduct_greater_or_lesser')
