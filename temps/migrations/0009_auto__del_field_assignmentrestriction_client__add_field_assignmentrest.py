...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssignmentRestriction.client'
        db.delete_column(u'temps_assignmentrestriction', 'client_id')

        # Adding field 'AssignmentRestriction.branch'
        db.add_column(u'temps_assignmentrestriction', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['agencies.Branch']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssignmentRestriction.client'
        db.add_column(u'temps_assignmentrestriction', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1100, related_name='rel_client', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'AssignmentRestriction.branch'
        db.delete_column(u'temps_assignmentrestriction', 'branch_id')
