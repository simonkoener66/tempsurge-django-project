...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field interest_code on 'Temp'
        m2m_table_name = db.shorten_name(u'temps_temp_interest_code')
    ...
    def backwards(self, orm):
        # Removing M2M table for field interest_code on 'Temp'
        db.delete_table(db.shorten_name(u'temps_temp_interest_code'))
    ...
    models = {
        ...
        u'temps.temp': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest_code': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['temps.InterestCode']", 'symmetrical': 'False'}),
