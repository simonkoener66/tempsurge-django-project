...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Temp.license_expire'
        db.alter_column(u'temps_temp', 'license_expire', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Temp.license_expire'
        db.alter_column(u'temps_temp', 'license_expire', self.gf('django.db.models.fields.DateTimeField')(null=True))
