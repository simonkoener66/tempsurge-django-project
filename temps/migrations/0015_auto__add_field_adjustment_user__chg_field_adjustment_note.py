...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjustment.user'
        db.add_column(u'temps_adjustment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Removing M2M table for field user on 'Adjustment'
        db.delete_table(db.shorten_name(u'temps_adjustment_user'))


        # Changing field 'Adjustment.note'
        db.alter_column(u'temps_adjustment', 'note', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

    def backwards(self, orm):
        # Deleting field 'Adjustment.user'
        db.delete_column(u'temps_adjustment', 'user_id')

        # Adding M2M table for field user on 'Adjustment'
        m2m_table_name = db.shorten_name(u'temps_adjustment_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('adjustment', models.ForeignKey(orm[u'temps.adjustment'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['adjustment_id', 'user_id'])


        # Changing field 'Adjustment.note'
        db.alter_column(u'temps_adjustment', 'note', self.gf('django.db.models.fields.IntegerField')(null=True))
