...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'temps_adjustmentrule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deduction_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
            ('deduction_amount_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('deduction_amount_from_total', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('apply_if_can_deducted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('when_to_apply', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ...
            ('maximum_deduction_amount_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('maximum_deduction_from_total', self.gf('django.db.models.fields.CharField')(max_length=1)),
