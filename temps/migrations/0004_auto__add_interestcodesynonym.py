...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'temps_interestcodesynonym', (
            ...
            ('interest_codes', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['temps.InterestCode'])),
        ))
    ...
    models = {
        ...
        u'temps.interestcodesynonym': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interest_codes': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['temps.InterestCode']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        u'temps.temp': {
