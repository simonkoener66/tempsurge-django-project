...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdjustmentRule.deduction_amount'
        db.alter_column(u'temps_adjustmentrule', 'deduction_amount', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'AdjustmentRule.deduction_amount'
        db.alter_column(u'temps_adjustmentrule', 'deduction_amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))
    ...
    models = {
        ...
        u'temps.adjustmentrule': {
            ...
            'when_to_apply_pay_type': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
