...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InterestCode.name'
        db.alter_column(u'temps_interestcode', 'name', self.gf('django.db.models.fields.CharField')(max_length=300))

    def backwards(self, orm):

        # Changing field 'InterestCode.name'
        db.alter_column(u'temps_interestcode', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))
