...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'temps_paycardaccount', (
            ...
            ('paycard_verified_by', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        db.create_table(u'temps_achbankaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bank_routing_info', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('account_number', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        # Adding field 'Temp.activate_electronic_payments'
        db.add_column(u'temps_temp', 'activate_electronic_payments',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Temp.electronic_payment_method'
        db.add_column(u'temps_temp', 'electronic_payment_method',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Temp.activate_electronic_payments'
        db.delete_column(u'temps_temp', 'activate_electronic_payments')

        # Deleting field 'Temp.electronic_payment_method'
        db.delete_column(u'temps_temp', 'electronic_payment_method')
    ...
    models = {
        ...
        u'temps.achbankaccount': {
            ...
            'bank_routing_info': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'temps.paycardaccount': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paycard_verified_by': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
