...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssignmentRestrictions'
        db.create_table(u'temps_assignmentrestrictions', (
            ...
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rel_client', to=orm['auth.User'])),
            ('temp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rel_temp', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'temps', ['AssignmentRestrictions'])


    def backwards(self, orm):
        # Deleting model 'AssignmentRestrictions'
        db.delete_table(u'temps_assignmentrestrictions')
    ...
    models = {
        ...
        u'temps.assignmentrestrictions': {
            'Meta': {'object_name': 'AssignmentRestrictions'},
            'all_departments': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'client': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rel_client'", 'to': u"orm['auth.User']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'temp': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rel_temp'", 'to': u"orm['auth.User']"})
        },
