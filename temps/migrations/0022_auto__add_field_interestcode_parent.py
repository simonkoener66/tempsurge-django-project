...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InterestCode.parent'
        db.add_column(u'temps_interestcode', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['temps.InterestCode']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InterestCode.parent'
        db.delete_column(u'temps_interestcode', 'parent_id')
