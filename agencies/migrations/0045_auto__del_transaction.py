...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'agencies_transaction')


    def backwards(self, orm):
        # Adding model 'Transaction'
        db.create_table(u'agencies_transaction', (
            ('session', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('proofed', self.gf('django.db.models.fields.BooleanField')()),
            ('timeentry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='timeentry', to=orm['agencies.TimeEntry'])),
            ('linked', self.gf('django.db.models.fields.BooleanField')()),
            ('posted', self.gf('django.db.models.fields.BooleanField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('paid', self.gf('django.db.models.fields.BooleanField')()),
            ('invoiced', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'agencies', ['Transaction'])
