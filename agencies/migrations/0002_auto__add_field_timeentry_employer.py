...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeEntry.employer'
        db.add_column(u'agencies_timeentry', 'employer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeEntry.employer'
        db.delete_column(u'agencies_timeentry', 'employer_id')
    ...
    models = {
        ...
        u'agencies.timeentry': {
            ...
            'employer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
