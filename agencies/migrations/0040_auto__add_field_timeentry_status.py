...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeEntry.status'
        db.add_column(u'agencies_timeentry', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeentry_status', null=True, to=orm['agencies.TimeEntryStatus']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeEntry.status'
        db.delete_column(u'agencies_timeentry', 'status_id')
    ...
    models = {
        ...
        u'agencies.timeentry': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'timeentry_status'", 'null': 'True', 'to': u"orm['agencies.TimeEntryStatus']"}),
        ...
        u'agencies.timeentrystatus': {
            'Meta': {'object_name': 'TimeEntryStatus'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
