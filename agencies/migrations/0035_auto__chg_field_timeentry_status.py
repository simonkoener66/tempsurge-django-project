...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeEntry.status'
        db.alter_column(u'agencies_timeentry', 'status', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'TimeEntry.status'
        db.alter_column(u'agencies_timeentry', 'status', self.gf('django.db.models.fields.IntegerField')(null=True))
