...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'agencies_check')


    def backwards(self, orm):
        # Adding model 'Check'
        db.create_table(u'agencies_check', (
            ('checkid', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('regular_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('weekendbill', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('overtime_units', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('employee_social_security_tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('regular_units', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('checknum', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('federal_single', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('employee_medical_tax', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('overtime_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='employee', null=True, to=orm['temps.Temp'], blank=True)),
            ('checkdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'agencies', ['Check'])
