...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.gross'
        db.add_column(u'agencies_invoice', 'gross',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.tax'
        db.add_column(u'agencies_invoice', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Invoice.net'
        db.add_column(u'agencies_invoice', 'net',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Check.gross'
        db.add_column(u'agencies_check', 'gross',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Check.tax'
        db.add_column(u'agencies_check', 'tax',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Check.net'
        db.add_column(u'agencies_check', 'net',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.gross'
        db.delete_column(u'agencies_invoice', 'gross')

        # Deleting field 'Invoice.tax'
        db.delete_column(u'agencies_invoice', 'tax')

        # Deleting field 'Invoice.net'
        db.delete_column(u'agencies_invoice', 'net')

        # Deleting field 'Check.gross'
        db.delete_column(u'agencies_check', 'gross')

        # Deleting field 'Check.tax'
        db.delete_column(u'agencies_check', 'tax')

        # Deleting field 'Check.net'
        db.delete_column(u'agencies_check', 'net')
    ...
    models = {
        ...
        u'agencies.check': {
            ...
            'tax': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'timeentry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'check_timeentry'", 'to': u"orm['agencies.TimeEntry']"})
        },
        u'agencies.company': {
        ...
        u'agencies.invoice': {
            ...
            'gross': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoicedate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'net': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'tax': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'timeentry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invoice_timeentry'", 'to': u"orm['agencies.TimeEntry']"})
        },
        u'agencies.paycode': {
