...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimeEntryStatus'
        db.create_table(u'agencies_timeentrystatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'agencies', ['TimeEntryStatus'])

        # Deleting field 'TimeEntry.status'
        db.delete_column(u'agencies_timeentry', 'status')


    def backwards(self, orm):
        # Deleting model 'TimeEntryStatus'
        db.delete_table(u'agencies_timeentrystatus')
