...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'agencies_invoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timeentry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoice_timeentry', to=orm['agencies.TimeEntry'])),
            ('invoicedate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'agencies', ['Invoice'])


    def backwards(self, orm):
        # Deleting model 'Invoice'
        db.delete_table(u'agencies_invoice')
