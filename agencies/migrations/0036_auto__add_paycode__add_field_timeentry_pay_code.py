...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PayCode'
        db.create_table(u'agencies_paycode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shortname', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('fullname', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'agencies', ['PayCode'])

        # Adding field 'TimeEntry.pay_code'
        db.add_column(u'agencies_timeentry', 'pay_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='timeentry_paycode', null=True, to=orm['agencies.PayCode']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PayCode'
        db.delete_table(u'agencies_paycode')

        # Deleting field 'TimeEntry.pay_code'
        db.delete_column(u'agencies_timeentry', 'pay_code_id')
