...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TimeEntry.job'
        db.delete_column(u'agencies_timeentry', 'job_id')
    ...
    def backwards(self, orm):
        # Adding field 'TimeEntry.job'
        db.add_column(u'agencies_timeentry', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='job', to=orm['employers.Job']),
                      keep_default=False)
    ...
    models = {
        ...
        u'agencies.timeentry': {
            ...
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timeentry_order'", 'to': u"orm['employers.WorkOrder']"}),
