...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeEntry.assignment'
        db.alter_column(u'agencies_timeentry', 'assignment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employers.Assignment']))

    def backwards(self, orm):

        # Changing field 'TimeEntry.assignment'
        db.alter_column(u'agencies_timeentry', 'assignment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employers.WorkOrder']))
