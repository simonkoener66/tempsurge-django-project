...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeEntry.hours_day1'
        db.add_column(u'agencies_timeentry', 'hours_day1',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'TimeEntry.hours_day2'
        db.add_column(u'agencies_timeentry', 'hours_day2',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'TimeEntry.hours_day3'
        db.add_column(u'agencies_timeentry', 'hours_day3',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'TimeEntry.hours_day4'
        db.add_column(u'agencies_timeentry', 'hours_day4',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'TimeEntry.hours_day5'
        db.add_column(u'agencies_timeentry', 'hours_day5',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'TimeEntry.hours_day6'
        db.add_column(u'agencies_timeentry', 'hours_day6',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'TimeEntry.hours_day7'
        db.add_column(u'agencies_timeentry', 'hours_day7',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeEntry.hours_day1'
        db.delete_column(u'agencies_timeentry', 'hours_day1')

        # Deleting field 'TimeEntry.hours_day2'
        db.delete_column(u'agencies_timeentry', 'hours_day2')

        # Deleting field 'TimeEntry.hours_day3'
        db.delete_column(u'agencies_timeentry', 'hours_day3')

        # Deleting field 'TimeEntry.hours_day4'
        db.delete_column(u'agencies_timeentry', 'hours_day4')

        # Deleting field 'TimeEntry.hours_day5'
        db.delete_column(u'agencies_timeentry', 'hours_day5')

        # Deleting field 'TimeEntry.hours_day6'
        db.delete_column(u'agencies_timeentry', 'hours_day6')

        # Deleting field 'TimeEntry.hours_day7'
        db.delete_column(u'agencies_timeentry', 'hours_day7')
    ...
    models = {
        ...
        u'agencies.check': {
            ...
            'checkdate': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'checkid': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'checknum': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'employee'", 'null': 'True', 'to': u"orm['temps.Temp']"}),
            'employee_medical_tax': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'employee_social_security_tax': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'federal_single': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'overtime_rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'overtime_units': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'regular_rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'regular_units': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'weekendbill': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})
        },
        u'agencies.company': {
        ...
        u'agencies.paycode': {
            'Meta': {'object_name': 'PayCode'},
            'fullname': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'shortname': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        ...
        u'agencies.timeentry': {
            ...
            'assignment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timeentry_assignment'", 'to': u"orm['employers.Assignment']"}),
            ...
            'dt_pay': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_day1': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_day2': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_day3': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_day4': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_day5': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_day6': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_day7': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_doubletime': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_overtime': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_regular': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            'hours_total_regular': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inv_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'number_of_days': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'pay_code': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'timeentry_paycode'", 'null': 'True', 'to': u"orm['agencies.PayCode']"}),
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'agencies.transaction': {
            'Meta': {'object_name': 'Transaction'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoiced': ('django.db.models.fields.BooleanField', [], {}),
            'linked': ('django.db.models.fields.BooleanField', [], {}),
            'paid': ('django.db.models.fields.BooleanField', [], {}),
            'posted': ('django.db.models.fields.BooleanField', [], {}),
            'proofed': ('django.db.models.fields.BooleanField', [], {}),
            'session': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'timeentry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timeentry'", 'to': u"orm['agencies.TimeEntry']"})
        },
        u'auth.group': {
