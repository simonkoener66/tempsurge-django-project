...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'agencies_timeentry', (
            ...
            ('webill', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('wedate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('workdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('invdate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'employers.job': {
            ...
            'temps': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['temps.Temp']", 'symmetrical': 'False'}),
