...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TimeEntry.hours_doubletime'
        db.alter_column(u'agencies_timeentry', 'hours_doubletime', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'TimeEntry.hours_overtime'
        db.alter_column(u'agencies_timeentry', 'hours_overtime', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'TimeEntry.hours_regular'
        db.alter_column(u'agencies_timeentry', 'hours_regular', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

        # Changing field 'TimeEntry.hours_total_regular'
        db.alter_column(u'agencies_timeentry', 'hours_total_regular', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'TimeEntry.hours_doubletime'
        db.alter_column(u'agencies_timeentry', 'hours_doubletime', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1))

        # Changing field 'TimeEntry.hours_overtime'
        db.alter_column(u'agencies_timeentry', 'hours_overtime', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1))

        # Changing field 'TimeEntry.hours_regular'
        db.alter_column(u'agencies_timeentry', 'hours_regular', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1))

        # Changing field 'TimeEntry.hours_total_regular'
        db.alter_column(u'agencies_timeentry', 'hours_total_regular', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=1))
