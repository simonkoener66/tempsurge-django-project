...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TimeEntry.order'
        db.delete_column(u'agencies_timeentry', 'order_id')

        # Adding field 'TimeEntry.Assignment'
        db.add_column(u'agencies_timeentry', 'Assignment',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='timeentry_assignment', to=orm['employers.WorkOrder']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TimeEntry.order'
        db.add_column(u'agencies_timeentry', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='timeentry_order', to=orm['employers.WorkOrder']),
                      keep_default=False)

        # Deleting field 'TimeEntry.Assignment'
        db.delete_column(u'agencies_timeentry', 'Assignment_id')
    ...
    models = {
        ...
        u'agencies.timeentry': {
            'Assignment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'timeentry_assignment'", 'to': u"orm['employers.WorkOrder']"}),
